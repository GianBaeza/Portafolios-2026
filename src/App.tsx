...
function App() {
    return (
        <div className="w-full relative min-h-screen flex items-center justify-center">
            ...
            <main className="w-11/12 md:w-10/12  lg:w-8/12 xl:w-5/10  h-full rounded-t-lg   flex flex-col gap-14 justify-start items-center bg-transparent scroll-smooth  z-10">
                <About />
                <Experience />
                <Proyectos />
                <Contact />
